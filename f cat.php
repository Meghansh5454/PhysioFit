...
<nav class="navbar">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4 " style="width:1500px;">
  <div class="col1">
  <a href="f body.php" target="_self" class="a">
    <div class="card text-center">
      <img src="image\f body pain.jpg" class="card-img-top" style="height:480px; " alt="...">
      <div class="card-body">
        <h5 class="card-title">Body Pain</h5>
  ...
  <div class="col2">
  <a href="f weight.php" target="_self" class="a">
    <div class="card text-center">
      <img src="image/f weight.jpg" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col3">
  <a href="f diseases.php" target="_self" class="a">
    <div class="card text-center">
      <img src="image/f disease.jpg" class="card-img-top" alt="...">
      <div class="card-body">
  ...
  <div class="col4">
  <a href="f pregnant.php" target="_self"class="a">
    <div class="card text-center">
      <img src="image/pregnant.jpg" class="card-img-top" alt="...">
      <div class="card-body">
