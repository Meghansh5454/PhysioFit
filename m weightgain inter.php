...
<head>
  ...
  <title>m weightgain inter</title>
...
<body>
  <div class="bg1">
    ...
    <div class="main">
        <div class="photo">
            <img src="image/m weightgain.jpg" width="600px" height="670px">
        </div>
      <div class="other">
      <form action="">
     <a href="exercise50.php" class="btn" name="card1">
      <div class="card1">
      <div class="myCard">
        <div class="innerCard">
            ...
            <div class="backSide">
                <p class="text">1.Lying Butterfly<br>
                2.Plank with Hands<br>
                3.Burpees<br>
                4.Revers Plank<br>
                5.High Praise
                </p>
