...
<body>
  <div class="bg1">
    ...
    <div class="main">
        <div class="photo">
            <img src="image/m stroke.webp" width="600px" height="670px">
        </div>
      <div class="other">
      <form action="">
     <a href="exercise58.php" class="btn" name="card1">
      <div class="card1">
      <div class="myCard">
        <div class="innerCard">
    ...
    <form action="">
     <a href="exercise.php" class="btn" name="card1">
    <div class="card6">
    <div class="myCard">
        <div class="innerCard">
            <div class="frontSide">
