...
<body>
  <div class="bg1">
    ...
    <div class="main">
        <div class="photo">
            <img src="image/m asthma.jpg" width="600px" height="670px">
        </div>
      <div class="other">
      <form action="">
      <a href="exercise66.php" class="btn" name="card1">
      <div class="card1">
      <div class="myCard">
        <div class="innerCard">
            ...
            <div class="backSide">
                <p class="text">1.Walking<br>
                2.Cycling<br>
                3.Standing Forward<br>
                4.Butterfly Pose<br>
    ...
    <form action="">
      <a href="exercise17.php" class="btn" name="card1">
    <div class="card7">
    <div class="myCard">
        <div class="innerCard">
            <div class="frontSide">
