...
<?php
    ...
    $query = "SELECT * FROM `exercises` WHERE `gender`='Male' AND  `category`='Weight' AND `subCategory`='Weight Loss' AND `level`='Intermediate'";
    ...
    <button onclick="window.open('deit loss.pdf', '_blank');" class="btn btn-primary pdf-btn">View Diet Chart</button>
