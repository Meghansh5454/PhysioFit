...
<a href="f pre beg.php" target="_self">
  <div class="card text-center mb-5" >
  <div class="card-body">
    <h5 class="card-title">First Trimester</h5> 
  </div>  
  </div>
</a>
  

<a href="f pre inter.php" target="_self">
  <div class="card text-center mb-5" >
  <div class="card-body">
    <h5 class="card-title">Second Trimester</h5>
  </div>  
  </div>
</a>
  

<a href="f pre ad.php" target="_self">
  <div class="card text-center">
  <div class="card-body">
    <h5 class="card-title">Third Trimester</h5>
  </div>  
  </div>
</a>
