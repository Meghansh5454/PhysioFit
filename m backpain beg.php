...
<body>
  <div class="bg1">
    ...
    <div class="main">
        <div class="photo">
            <img src="image/m backpain.jpg" width="600px" height="670px">
        </div>
      <div class="other">
     ...
     <form action="">
      <a href="exercise37.php" class="btn" name="card1">
     <div class="card1">
      <div class="myCard">
        <div class="innerCard">
            ...
            <div class="backSide">
            <p class="text">1.Back Extension<br>
                2.Knee to Chest Stretch<br>
                3.Plank<br>
                4.Side Plank<br>
                5.Cobra Pose
                </p>
