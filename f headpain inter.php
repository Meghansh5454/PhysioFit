...
<body>
  <div class="bg1">
    ...
    <div class="main">
        <div class="photo">
            <img src="image/f head pain.jpg" width="600px" height="670px">
        </div>
      <div class="other">
      <form action="">
      <a href="exercise11.php" class="btn" name="card1">
      <div class="card1">
      <div class="myCard">
        <div class="innerCard">
            ...
            <div class="backSide">
                <p class="text">1.Upper Head Stretching<br>
                2.Head Rotation<br>
                3.Child Pose<br>
                4.Cat Cow Stretch<br>
                5.Meditation
                </p>
