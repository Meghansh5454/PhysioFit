...
<div class="row row-cols-1 row-cols-md-3 g-4" style="width:1500px;">
  <div class="col">
  <a href="m body.php" target="_self" class="a">
    <div class="card">
      <img src="image/m body pain  cat.jpg" class="card-img-top" style="height: 550px;" alt="...">
      <div class="card-body">
        <h5 class="card-title text-center">Body Pain</h5>
  ...
  <div class="col">
  <a href="m weight.php" target="_self" class="a">
    <div class="card">
      <img src="image/m weight cat.jpg" class="card-img-top" style="height: 550px;">
      <div class="card-body">
  ...
  <div class="col">
  <a href="m diseases.php" target="_self" class="a">
    <div class="card">
      <img src="image/m disease cat.jpg" class="card-img-top" style="height: 550px;">
      <div class="card-body">
        <h5 class="card-title text-center">Diseases</h5>
      </div>
    </div>
</a>
  </div>
