...
.a{
  ...
  <div class="colmain">
    <div class="main">
    <div class="card1 ">
      <div class="img1"><img src="image/pregnant.jpg" class="card-img-top" alt="..."></div>
      <div class="card-body">
     ...
     <div class="col2">
     <a href="f pre.php" target="_self" class="a">
  <div class="card" style="width: 18rem;">
  <img src="image/pre.jpg" class="card-img-top" height="200px">
  <div class="card-body">
  <h6 class="card-title text-center">Prenatal</h6>
     </div>
  </div>
</a>
</div>
     ...
     <div class="row" style="width:150px;">
     <div class="col3">
     <a href="f post.php" target="_self" class="a">
  <div class="card" style="width: 18rem;">
  <img src="image/post.jpg" class="card-img-top"height="200px">
  <div class="card-body">
  <h6 class="card-title text-center">Postnatal </h6>
     </div>
  </div>
</a>
</div>
