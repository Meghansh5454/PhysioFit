...
<body>
  <div class="bg1">
    ...
    <div class="main">
        <div class="photo">
            <img src="image/pre.jpg" width="600px" height="670px">
        </div>
      <div class="other">
      <form action="">
      <a href="exercise31.php" class="btn" name="card1">
      ...
      <div class="myCard">
        <div class="innerCard">
            ...
            <div class="backSide">
                <p class="text">1.Lungs<br>
                2.Walking<br>
                3.Cat-Cow Stretch<br>
                4.Triangle Pose<br>
                5.Heel Raise
                </p>
