...
<?php
    // Female // Body Pain // Back Pain // Intermediate
    $query = "SELECT * FROM `exercises` WHERE `gender`='Female' AND  `category`='Weight' AND `subCategory`='Weight Gain' AND `level`='Intermediate'";
    ...
    <button class="pdf-btn" onclick="window.open('diet gain.pdf', '_blank');">View Diet Plan</button>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var alarmSound = new Audio('Female.mp3');
