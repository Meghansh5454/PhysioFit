...
<?php
    ...
    $query = "SELECT * FROM `exercises` WHERE `gender`='Female' AND  `category`='Weight' AND `subCategory`='Weight Loss' AND `level`='Intermediate'";
    ...
    <button class="pdf-btn" onclick="window.open('deit loss.pdf', '_blank');">View Diet Plan</button>
