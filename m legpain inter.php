...
<body>
  <div class="bg1">
    ...
    <div class="main">
        <div class="photo">
            <img src="image/m legpain.webp" width="600px" height="670px">
        </div>
      <div class="other">
      <form action="">
     <a href="exercise44.php" class="btn" name="card1">
      <div class="card1">
      <div class="myCard">
        <div class="innerCard">
            ...
            <div class="backSide">
                <p class="text">1.Elbow to Knee Touch<br>
                2.Towel Curls<br>
                3.Foot Raising<br>
                4.Squats<br>
                5.Knee Stretch
