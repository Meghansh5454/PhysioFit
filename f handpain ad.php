...
<body>
  <div class="bg1">
    ...
    <div class="main">
        <div class="photo">
            <img src="image/f hand pain.jpg" width="600px" height="670px">
        </div>
      <div class="other">
      <form action="">
      <a href="exercise6.php" class="btn" name="card1">
      <div class="card1">
      <div class="myCard">
        <div class="innerCard">
            ...
            <div class="backSide">
                <p class="text">1.Dips<br>
                2.Revrese Boat Pose<br>
                3.Child Pose <br>
                4.Hip Raise<br>
                5.Y-Stretch
                </p>
