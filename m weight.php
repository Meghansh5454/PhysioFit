...
.a{
  ...
  <div class="colmain">
    <div class="main">
    <div class="card1 ">
      <div class="img1"><img src="image/m weight.jpg" class="card-img-top" alt="..."></div>
      <div class="card-body">
     </div>
      </div>
    </div>
     ...
     <div class="col2">
     <a href="m weightgain.php" target="_self" class="a">
  <div class="card" style="width: 18rem;">
  <img src="image/m weightgain.jpg" class="card-img-top"height="200px">
  <div class="card-body">
  <h6 class="card-title text-center">Weight Gain</h6>
     ...
     <div class="row" style="width:150px;">
     <div class="col3">
     <a href="m weightloss.php" target="_self" class="a">
  <div class="card" style="width: 18rem;">
  <img src="image/m weightloss.jpg" class="card-img-top"height="200px">
  <div class="card-body">
