...
<body>
  <div class="bg1">
    ...
    <div class="main">
        <div class="photo">
            <img src="image/f vertigo.webp" width="600px" height="670px">
        </div>
      <div class="other">
      <form action="">
      <a href="exercise27.php" class="btn" name="card1">
      <div class="card1">
      <div class="myCard">
        <div class="innerCard">
            ...
            <div class="backSide">
                <p class="text">1.Meditation<br>
                2.Walking<br>
                3.Cow-Cat Stretch<br>
                4.Touch-toes<br>
                5.Calf Stretch
                </p>
