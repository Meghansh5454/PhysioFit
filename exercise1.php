...
<?php
    // Female // Body Pain // Back Pain // Beginner
    $query = "SELECT * FROM `exercises` WHERE `gender`='Female' AND  `category`='Body Pain' AND `subCategory`='Back Pain' AND `level`='Beginner'";
