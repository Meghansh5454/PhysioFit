...
<body>
  <div class="bg1">
    ...
    <div class="main">
        <div class="photo">
            <img src="image/m handpain.jpg" width="600px" height="670px">
        </div>
      <div class="other">
      <form action="">
     <a href="exercise40.php" class="btn" name="card1">
      <div class="card1">
      <div class="myCard">
        <div class="innerCard">
            ...
            <div class="backSide">
                <p class="text">1.Arm Circle<br>
                2.Cross Body Arm Stretch<br>
                3.Towel Stretch <br>
                4.Wrist Rotation<br>
                5.Wall Pushups
                </p>
