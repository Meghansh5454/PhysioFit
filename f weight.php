...
<head>
  ...
  .img1{
    ...
    .colmain{
     ...
     .col2{
      margin:50px -480px 0px 480px;}
     .col3{
     margin:-260px -780px 0px 780px;}
     .card {
      color:white;
  border-radius: 20px;
...
.a{
  ...
  <div class="colmain">
    <div class="main">
    <div class="card1">
      <div class="img1"><img src="image/f weight.jpg" class="card-img-top" alt="..."></div>
      <div class="card-body">
     ...
     <div class="col2">
     <a href="f weight gain.php" target="_self" class="a">
  <div class="card" style="width: 18rem;">
  <img src="image/f weightloss.jpg" class="card-img-top"height="200px">
  <div class="card-body">
  <h6 class="card-title text-center">Weight Gain</h6>
     </div>
  </div>
</a>
</div>
     ...
     <div class="row" style="width:150px;">
     <div class="col3">
     <a href="f weight loss.php" target="_self" class="a">
  <div class="card" style="width: 18rem;">
  <img src="image/f weightgain.jpg" class="card-img-top"height="200px">
  <div class="card-body">
  <h6 class="card-title text-center">Weight Loss</h6>
     </div>
  </div>
</a>
</div>
