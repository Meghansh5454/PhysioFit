 ...
 <?php include "config.php"; ?>
    ...
    <head>
        ...
        <style>
            ...
            body {
                background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('image/exbg.jpg');                background-attachment: fixed;
...
<?php
    ...
    $query = "SELECT * FROM `exercises` WHERE `gender`='Female' AND  `category`='Disease' AND `subCategory`='Vertigo' AND `level`='Intermediate'";
